...
public class @PingWheelStartAssets : IInputActionCollection, IDisposable
{
    public InputActionAsset asset { get; }
    public @PingWheelStartAssets()
    {
    ...
    {
        private @PingWheelStartAssets m_Wrapper;
        public PlayerActions(@PingWheelStartAssets wrapper) { m_Wrapper = wrapper; }
